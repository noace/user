...
import ConfirmationDialog from "./add";
import ConfirmationDialogEdit from "./edit";
...
class SimpleTable extends React.Component<any, any> {
    open: any;
    ...
    hanleDelete = async (id: number) => {
        this.handleOpen();
        console.log(id);
        const users = this.state.users.filter((userList :any) => id !== userList.id);

...
function ConfirmationDialogRaw(props:IProps) {
    ...
    const radioGroupRef = React.useRef(null as any);
    ...
    //更改name值
    const handleGetName = (event:any) => {
        setUsers({ ...users, name: event.target.value });
    };

    const handleGetAge = (event:any) => {
        setUsers({ ...users, age: event.target.value });
    };

    const handleGetSex = (event:any) => {
...
export default function ConfirmationDialogEdit(props:any) {
